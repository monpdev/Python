...
for tr in daily_transactions:
 daily_transactions_split.append(tr.split(';'))
...
for transaction in daily_transactions_split:
  ...
  for item in transaction:
    tr_clean.append(item.replace('\n',' ').strip(' '))
  transactions_clean.append(tr_clean)
